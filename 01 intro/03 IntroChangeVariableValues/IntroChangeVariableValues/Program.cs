...
namespace IntroChangeVariableValues
{
    internal class Program
    {
        ...
        private void Run()
        {
            ...
            myFavoriteCity = "Hoorn"; //geef hier myFavoriteCity een waarde 
            myFavoriteNumber = "10"; //geef hier myFavoriteNumber een waarde 
            displayNumber = "69"; //zet displayNumber op true
            Display();

            //nu gaan we de waarden instellen voor luigi, gebruik andere waardes

            characterName = "Finn";
            currentTime = "10:25";//zoek op hoe je de huidige tijd kan krijgen (DateTime.???)
            myFavoriteCity = "Hoorn"; //geef hier myFavoriteCity een waarde 
            myFavoriteNumber = "10"; //geef hier myFavoriteNumber een waarde 
            displayNumber = "69"; //zet displayNumber op false
            Display();
        }
